...
export default function NotFoundWrapper({ itemName = "products", className = "", isFeatured = false }: NotFoundWrapperProps) {

  if (isFeatured) {
    return (
      <div className={`flex flex-col justify-center items-center ${className} p-6 pb-0`}>
        <h1 className="text-base font-semibold text-gray-600 mb-2">
